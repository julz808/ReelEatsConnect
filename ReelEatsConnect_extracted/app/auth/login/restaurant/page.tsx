          ...
          <div className="w-full max-w-md">
            <div className="mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              <h1 className="font-heading font-bold text-4xl md:text-5xl mb-4">
                Welcome back, <span className="text-primary">Venue</span>
              </h1>
              <p className="text-lg text-gray-600">
                Sign in to continue finding talented creators
              </p>
            </div>
            ...
            <form onSubmit={handleEmailLogin} className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100">
              ...
              <div className="text-center pt-4">
                <p className="text-sm text-gray-600">
                  ...
                  <Link href="/auth/signup/restaurant" className="text-primary font-semibold hover:underline transition-colors">
                    Create account
                  </Link>
                </p>
              </div>
        ...
        <div className="absolute inset-0 flex items-center justify-center p-16">
          <div className="max-w-lg text-center animate-in fade-in slide-in-from-right duration-1000 delay-300">
            ...
            <h2 className="font-heading font-bold text-4xl mb-6 text-gray-900">
              Your Creator Network Awaits
            </h2>
            <p className="text-lg text-gray-700 leading-relaxed">
              Continue growing your venue's reach with Melbourne's talented food content creators.
            </p>
          </div>
        </div>
      </div>
